  ...
  return (
    <section className="py-16 px-4 xl:px-16 relative bg-transparent overflow-hidden">
        ...
        {achievementsList.map((achievement, index) => {
          ...
          return (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative bg-neutral-900/40 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-lg overflow-hidden"
            >
              ...
              <div className="relative p-8">
                {/* Icon */}
                <div className="mb-6">
                  <div className="w-12 h-12 bg-white/5 group-hover:bg-white transition-all duration-300 flex items-center justify-center">
                    <Icon className="w-6 h-6 text-neutral-300 group-hover:text-neutral-950 transition-all duration-300" />
                  </div>
                </div>
                
                {/* Highlight Badge */}
                <div className="mb-4">
                  <span className="text-xs uppercase tracking-wider text-neutral-300 bg-white/5 px-2 py-1">
                ...
                <div className="mb-4">
                  <h3 className="text-5xl md:text-6xl font-light text-neutral-100 leading-none tracking-tight">
                    {achievement.value}
                  </h3>
                </div>
                ...
                {/* Metric Title */}
                <div className="mb-3">
                  <h4 className="text-lg font-light text-neutral-100 uppercase tracking-wider">
                    {achievement.metric}
                  </h4>
                </div>
      ...
      <div className="mt-16 text-center">
        <div className="inline-flex items-center gap-4 text-sm text-neutral-400 uppercase tracking-wider">
